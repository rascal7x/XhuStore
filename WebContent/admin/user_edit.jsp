...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="userUpdate.action" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name" name="user.phone" value="${user.phone}">
			</div>
		</div>
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">地址</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name" name="user.address" value="${user.address}">
			</div>
		</div>
		<div class="form-group">
